    ...
    <nav class="bg-gray-800 p-4">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <ul class="flex space-x-4 font-oswald">
                ...
                <li><a href="{{ url('/properties') }}" class="text-white hover:text-gray-400">Properties</a></li>
                <li><a href="{{ url('/profile') }}" class="text-white hover:text-gray-400">Profile</a></li>
